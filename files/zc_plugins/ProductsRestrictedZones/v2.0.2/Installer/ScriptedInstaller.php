    ...
    protected function executeInstall(): bool
    {
        ...
        $this->executeInstallerSql(
            "INSERT IGNORE INTO " . TABLE_CONFIGURATION . "
             ...
             VALUES
                ('Installed version', 'PRODUCTS_RESTRICTED_ZONE_VERSION', '2.0.2', 'Installed Products Restricted Zones version.', {$this->cgi}, 0, 'zen_cfg_select_option(array(\'2.0.2\'),', NOW()),
        ...
        $this->executeInstallerSql(
            "UPDATE " . TABLE_CONFIGURATION . " SET configuration_value = '2.0.2', configuration_group_id = {$this->cgi}, set_function = 'zen_cfg_select_option(array(\'2.0.2\'),' WHERE configuration_key = 'PRODUCTS_RESTRICTED_ZONE_VERSION'"
        );
        $this->executeInstallerSql(
